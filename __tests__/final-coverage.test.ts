...
describe('Final Coverage Tests', () => {
  ...
  describe('deepUnwrap Coverage', () => {
    ...
    test('should handle circular references', () => {
      ...
      // The function returns [Circular Reference] for circular references
      // because JSON.stringify fails on circular structures
  ...
  describe('saveAsCsv Coverage', () => {
    test('should handle directory does not exist error', async () => {
      ...
      error.code = 'ENOENT';
      mockedFs.promises.mkdir.mockRejectedValue(error);
